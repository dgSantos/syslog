 ...
 * 
 */
package br.com.walmart.syslog.dao;
...
public class MapaDAO implements MapaDAOInterface {
  ...
  /* (non-Javadoc)
   * @see br.com.walmart.syslog.dao.MapaDAOInterface#obtemMapaPorNome(java.lang.String)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see br.com.walmart.syslog.dao.MapaDAOInterface#persisteMapa(br.com.walmart.syslog.dao.model.MapaEntity)
   */
  @Override
